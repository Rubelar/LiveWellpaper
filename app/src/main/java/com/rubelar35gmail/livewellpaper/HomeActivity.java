...
import com.rubelar35gmail.livewellpaper.Adapter.MyFragmentAdapter;
...
public class HomeActivity extends AppCompatActivity
    ...
    BottomNavigationView menu_bootom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_bootom = (BottomNavigationView)findViewById(R.id.navigation);
        menu_bootom.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
